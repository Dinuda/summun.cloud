...
const capturePath = process.env.SUMMUN_TEST_CAPTURE_PATH;
const payload = {
    ...
    try {
      const result = await execute({
        ...
        config: {
          ...
          model: "auto",
          env: {
            SUMMUN_TEST_CAPTURE_PATH: capturePath,
          },
      ...
      expect(capture.summunEnvKeys).toEqual(
      ...
      expect(capture.prompt).toContain("SUMMUN_API_KEY");
      expect(invocationPrompt).toContain("Paperclip runtime note:");
      expect(invocationPrompt).toContain("SUMMUN_API_URL");
    } finally {
