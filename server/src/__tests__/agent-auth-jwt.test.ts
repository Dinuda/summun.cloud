...
describe("agent local JWT", () => {
  const secretEnv = "SUMMUN_AGENT_JWT_SECRET";
  const ttlEnv = "SUMMUN_AGENT_JWT_TTL_SECONDS";
  const issuerEnv = "SUMMUN_AGENT_JWT_ISSUER";
  const audienceEnv = "SUMMUN_AGENT_JWT_AUDIENCE";
